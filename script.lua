-- ==================================================
-- Obfuscated Script: Gemini V2 Free Model
-- ==================================================
...
local _d = {
    ...
    "screenGui.Name=\"GeminiV2FreeModelGui\"",
    ...
    "toggleMenuBtn.Size=UDim2.new(0,150,0,45)",
    "toggleMenuBtn.Position=UDim2.new(0,20,0,20)",
    "toggleMenuBtn.Text=\"Gemini V2 Free Model\"",
    ...
    "toggleMenuBtn.Text=menuOpen and \"Gemini V2 Free Model (Close)\" or \"Gemini V2 Free Model\"",
    "end)",
    ...
    "playerDrawings[p].TracerLine:Remove() playerDrawings[p].NameText:Remove() playerDrawings[p].HealthText:Remove()",
    ...
    "local height=math.abs(topPos.Y-bottomPos.Y) local width=height/2 local x,y=topPos.X-width/2,topPos.Y local l=drawings.CornerLines local wLen,hLen=width/4,height/4",
...
if _f then
    ...
    error("Execution Error: " .. tostring(_e))
end
